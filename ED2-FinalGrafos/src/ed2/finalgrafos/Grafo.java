...
public class Grafo {
    ...
    /*  2. G1.CantidadTotaldeFormasdeLlegadas(name1, name2) : Cantidad total de formas de llegadas que existen desde el nodo name1 hasta name2.*/
    public int CantidadTotaldeFormasdeLlegadas(String nombreInicio, String nombreDestino) {
        Nodo nodoInicio = buscarNodo(nombreInicio);
        Nodo nodoDestino = buscarNodo(nombreDestino);
        if (nodoInicio == null || nodoDestino == null) {
            return 0;
    ...
    /*  3. G1.mostrarCaminosysuValorTotal(name1, name2) : con su valor total del recorrido.*/
    public void mostrarCaminosysuValorTotal(String nombreInicio, String nombreDestino) {
        Nodo nodoInicio = buscarNodo(nombreInicio);
        Nodo nodoDestino = buscarNodo(nombreDestino);
        if (nodoInicio == null || nodoDestino == null) {
